...
function create() {
  ...
  for (var lin = 0; lin < 10; lin++) {
    for (var col = 0; col < 10; col++) {
      // adicionar gramado
      var gramado = chaoLayer.create(40 + lin * 80, 40 + col * 80, 'gramado')
      //Escalacionar a sprite para 80x80 px
      //set the width of the sprite
      //gramado.displayWidth = 80;
      //scale evenly
      //gramado.scaleY = chao.scaleX;
      ...
      var chao = pistaLayer.create(40 + lin * 80, 40 + col * 80, tipo)

      //Escalacionar a sprite para 80x80 px
      //set the width of the sprite
      chao.displayWidth = 40;
      //scale evenly
      chao.scaleX = chao.scaleY;
      }
