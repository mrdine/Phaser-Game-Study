...
function preload() {
    ...
    // player
    this.load.spritesheet('player', './assets/player/sheetPlayer.png', { frameWidth: 55, frameHeight: 64 })
}
...
function create() {
        ...
        for (var col = 0; col < 10; col++) {
            ...
            if (value != i) {
                ...
                if (value === 7 || value === 8 || value === 9 || value === 10) {
                    // bottonLayer
                    var bl = pbLayer.create(lin * spriteSize, col * spriteSize, theSprite).setOrigin(0, 0)
                    // resize sprite
    ...
    this.physics.add.collider(player, pbLayer);
